...
input_file_path = '/home/tto/jank/nmt/IN-22/Hin.txt'  # Input Hindi file path
output_file_path = 'hi_en_gen_translation_output.txt'  # Output file path
...
def task(input_file_path, output_file_path):
    ...
    print(f"Translation completed in {elapsed_time:.2f} seconds. Results are saved in {output_file_path}.")
